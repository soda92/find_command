...
def make_exe():
    ...
    # python_config.run_command = "import package;"
    ...
    # python_config.run_command = "from package import where_command; where_command.main()"

    # Run a Python module as __main__ when the interpreter starts.
    python_config.run_module = "package"

    # Run a Python file when the interpreter starts.
    # python_config.run_filename = "gui.py"
    ...
    for resource in exe.pip_install(["termcolor"]):
